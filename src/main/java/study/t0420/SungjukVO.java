...
public class SungjukVO {
	...
	public SungjukVO(String name, String gender, String no, String hakyun, int kor, int eng, int mat, int tot,
			double avg, String grade, String[] sports, String otherSports, String[] language, String strSports,String strlanguage) {
		this.name = name;
		this.gender = gender;
		this.no = no;
		this.hakyun = hakyun;
