	...
	<form name="myForm" method="post" action="${ctp}/urlMappingUpdateOk.um">
		<table class="table">
			...
			<tr>
				...
				<input type="button" value="회원정보수정" class="btn btn-secondary" onclick="fCheck();"/> &nbsp;
				<input type="button" value="돌아가기" class="btn btn-secondary" onclick="location.href='${ctp}/urlMappingList.um';"/>
				</td>
			</tr>
		</table>
