...
insert into guest values (default, '관리자', 'ljs1877@gmail.com', 'turn-butterfly.tistory.com', default, '192.168.50.103', '방명록 서비스를 시작합니다.');
insert into guest values (default, '강감찬', 'kgc1234@naver.com', '', default, '210.28.55.10', '귀사의 번영을 기원합니다.');
