...
<div class="container" style="padding:30px">
  <form name="myForm" method="post" action="${ctp}/memJoinOk.mem" class="was-validated">
    ...
    <div class="form-group">
      ...
      <div class="invalid-feedback">비밀번호는 필수 입력사항입니다. <br> 1개이상의 '문자'와 '특수문자' 조합의 6~24 자리로 작성하세요. </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <%-- <fmt:parseDate var="birthday" value="서버변수" pattern="yyyy-MM-dd"/> 서버변수란 request.set으로 넘긴 값의 변수를 말함.--%>
