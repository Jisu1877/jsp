...
<c:set var="kor" value="${param.kor + 10}"/> <!-- 값을 10을 더함으로 값변조  -->
...
Form태그의 변수명  setProperty의 변수명 VO의 변수명이 같으면 이렇게 적어도 모든 값이 다 set 된다.--%>
...
<jsp:setProperty name="vo" property="kor" value="${kor}"/> <!-- 값변조했기에 value를 적어줘야함.  -->
...
<div class="container">
	...
	<table class="table table-hover text-center">
		...
		<tr>
			<td colspan="2">
				<input type="button" value="돌아가기" onclick="location.href='<%=request.getContextPath()%>/0421/sungjuk3.jsp'" class="btn btn-info form-control"/>
			</td>
		</tr>	
	</table>
</div>
