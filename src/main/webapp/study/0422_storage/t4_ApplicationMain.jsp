...
<div class="container">
	...
	<hr/>
	<div><a href="t4_ApplicationSave.jsp" class="btn btn-success form-control m-1">Application 저장(서버 기동후 '처음 1회'만 수행할 것)</a></div>
	<div><a href="t4_ApplicationCheck.jsp" class="btn btn-success form-control m-1">Application 확인</a></div>
	<div><a href="t4_ApplicationDelete.jsp" class="btn btn-success form-control m-1">Application 삭제</a></div>
</div>
<p><br/><p>
</body>
</html>